...
import { deleteObjectFields } from "../../helper/Helper";
...
export default function EditEquipmentRequest() {
  ...
  const handleOnSubmit = (e) => {
    ...
    if (isValidForm(errors)) {
      ...
      axios
        .put(`/equipment/edit-request-equipment/${id}`, formData, config)
        .then((res) => {
          setLoading(false);

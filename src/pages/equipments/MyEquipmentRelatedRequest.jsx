...
export default function MyEquipmentRelatedRequest() {
  const per_page = 10;
  ...
  const getAllEquipments = () => {
    ...
    axios
      .get(
        `/equipment/my-equipment-related-request?per_page=${per_page}&page=${currentPage}&search=${search}`,
        config
      )
      .then((res) => {
        setLoading(false);
        ...
        <div className="equipment-sec">
          <div className="row">
            <div className="col-sm-6 align-self-center">
              <h2>My Equipment Related Request</h2>
            </div>
            <div className="col-sm-6 align-self-center">
